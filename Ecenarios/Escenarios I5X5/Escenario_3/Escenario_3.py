...
def generar_imagenes_y_etiquetas(num_imagenes=10, tamano=(5, 5)):
    imagenes = []
    etiquetas = []
    ...
    for _ in range(num_imagenes):
        ...
        # Determinar las coordenadas del centro de la imagen
        centro_x, centro_y = tamano[0] // 2, tamano[1] // 2
        
        # Asignar la etiqueta según el píxel en el centro
        etiqueta = "sí" if imagen[centro_x, centro_y] == 0 else "no"
